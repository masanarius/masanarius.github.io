document.addEventListener("DOMContentLoaded", () => {
    // Constants
    const jsonFilePath = "json/about_education.json"; // JSON file path
    const displayTable = document.querySelector("#education-table tbody"); // Table to display data
    const toggleButton = document.querySelector("[data-key='about.show-more-education']"); // Button to show more
