document.addEventListener("DOMContentLoaded", () => {
    const jsonFilePath = "json/publication_journal.json";
    const displayContainer = document.querySelector("#journal-container"); // Container for publications
    const showMoreButton = document.querySelector("[data-key='publication.show-more-journal']");
