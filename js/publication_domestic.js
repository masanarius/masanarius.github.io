document.addEventListener("DOMContentLoaded", () => {
    const jsonFilePath = "json/publication_domestic.json";
    const displayContainer = document.querySelector("#domestic-container"); // Container for publications
    const showMoreButton = document.querySelector("[data-key='publication.show-more-domestic']");
