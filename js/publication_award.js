document.addEventListener("DOMContentLoaded", () => {
    const jsonFilePath = "json/publication_award.json";
    const displayContainer = document.querySelector("#award-container"); // Container for publications
    const showMoreButton = document.querySelector("[data-key='publication.show-more-award']");
