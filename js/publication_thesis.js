document.addEventListener("DOMContentLoaded", () => {
    const jsonFilePath = "json/publication_thesis.json";
    const displayContainer = document.querySelector("#thesis-container"); // Container for publications
    const showMoreButton = document.querySelector("[data-key='publication.show-more-thesis']");
