document.addEventListener("DOMContentLoaded", () => {
    const jsonFilePath = "json/publication_fund.json";
    const displayContainer = document.querySelector("#fund-container"); // Container for publications
    const showMoreButton = document.querySelector("[data-key='publication.show-more-fund']");
