document.addEventListener("DOMContentLoaded", () => {
    const jsonFilePath = "json/publication_other.json";
    const displayContainer = document.querySelector("#other-container"); // Container for publications
    const showMoreButton = document.querySelector("[data-key='publication.show-more-other']");
