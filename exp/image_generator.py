...
PLUS_OUT_THICK = int(SIZE * 0.60)  # pbd：太い
PLUS_OUT_THIN  = int(SIZE * 0.30)  # plt：細い
...
# 形状一覧（新規：pnt, hex, oct を追加）
shapes   = ["squ", "cir", "tri", "pbd", "plt", "pnt", "hex", "oct"]
...
print("✅ 透明背景で 7色×8模様×8形状（squ，cir，tri，pbd，plt，pnt，hex，oct）を保存しました．")
